...
주요 기능
- 반복적인 업무를 최소화 하여 보호소 직원들이 <br>
  동물 복지 및 입양 상담과 같은 중요한 일에 집중할 수 있도록 지원합니다.
- 데이터 시각화를 통해 입양 트렌드를 파악하고 마케팅 전략을 수립할 수 있습니다.
  
<br>

특징
- 한국의 보호소 환경에 특화된 그룹웨어로, <br>
  현재 시장에 유사한 솔루션이 없어 큰 잠재력을 가지고 있는 것이 특징입니다.
...
| 정근희   | <img src="https://github.com/user-attachments/assets/f63fb788-dbc7-485c-a643-0971e19dd89e" width="130"> | 형상관리자 | 로그인, 사번&비밀번호 찾기, 메인화면, 결재, 관리자페이지 |
